...
<body id="#body">
    <div id="notification-banner-container" class="w-1/4 z-50 absolute right-0 h-screen overflow-y-hidden">
    </div>
    ...
    <div id="cash-confirm-frame" class="w-full hidden h-full grid bg-white bg-opacity-40 z-40 absolute">
        <div class="w-1/2 bg-gray-300 text-center grid h-32 mr-auto ml-auto mt-auto mb-auto">
            ...
            <input id="cash" type="number" step="any" placeholder="Enter Cash" class="focus:outline-none mr-auto ml-auto mt-2 w-3/4 h-8">
            <div class="w-full h-12 grid text-center grid-cols-2">
    ...
    <div class="w-screen h-screen flex">
        ...
        <div class="bg-gray-500 w-full text-black flex flex-col">
            ...
            <div class="w-full  h-full z-20  flex flex-row">
                <div class="w-3/4 h-11/12 overflow-y-scroll">
                ...
                <div class="w-1/4 h-full ">
                    <div class="mt-48">
                        ...
                        <div class="w-full grid grid-cols-2 mt-4">
                            <button class="bg-red-400 w-3/4 h-12 mr-auto ml-auto focus:outline-none cursor-pointer">Process</button>
